        ...
        <div class="footer__container container grid">
            <div class="footer__content grid">
                <div class="footer__data">
                    <h3 class="footer__title">wizz</h3>
                    <p class="footer__description">Make your dream wedding <br> Hope,
                        you all the best <br> experience.
                    </p>
                    <div>
                ...
                <div class="footer__data">
                    <h3 class="footer__subtitle">guide</h3>
                    <ul>
                        <li class="footer__item">
                        ...
                        <li class="footer__item">
                            <a href="" class="footer__link">package</a>
                        </li>
                    </ul>
                </div>
